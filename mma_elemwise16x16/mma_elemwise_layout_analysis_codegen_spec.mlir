...
module attributes { transform.with_named_sequence } {
  ...
  transform.named_sequence @custom_mma(%attention: !transform.any_op {transform.readonly}) {
  ...
  transform.named_sequence @match_mma(%attention: !transform.any_op {transform.readonly}) -> (!transform.any_op) {
    transform.match.operation_name %attention ["linalg.matmul_transpose_b"] : !transform.any_op
